...
def main():
    ...
    while True:
        ...
        if GetAsyncKeyState(win32con.VK_MENU) & 0x8000:  # بررسی فشار دادن دکمه ALT
            print("دکمه ALT فشار داده شد.")
            
            # گرفتن عدد از تصویر هر بار که ALT فشار داده می‌شود
            ...
            # انجام کلیک چپ مجدد پس از تاخیر
            click_left()
            print("کلیک چپ مجدد انجام شد.")
            
            # بروزرسانی زمان آخرین حمله
